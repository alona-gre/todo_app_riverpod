...
class AddedItemsBuilder extends StatelessWidget {
  const AddedItemsBuilder({
    super.key,
    required this.items,
    required this.itemBuilder,
  });
  final List<AddedItem> items;
  final Widget Function(BuildContext, AddedItem, int) itemBuilder;
  ...
  Widget build(BuildContext context) {
    ...
    if (items.isEmpty) {
      return EmptyPlaceholderWidget(
        message: 'Your added is empty'.hardcoded,
      );
    }
